...
function getVentasChecklist(colorClass, inlineColor) {
    let iconStyle = inlineColor ? style="color: ;" : class="";
    return 
                                    <ul class="list-unstyled check-list mb-4" style="font-size: 0.85rem;">
                                        <li><i class="bi bi-check-circle-fill" ></i> Punto de Venta (POS)</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Módulo de Compras</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Gestión de Clientes y Proveedores</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Reportes Automáticos</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Kardex en Tiempo Real</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Alertas de Vencimiento</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Apertura y Cierre de Caja</li>
                                        <li><i class="bi bi-check-circle-fill" ></i> Multiusuario</li>
                                    </ul>;
}

// Replace in boticaPrecio
...
let newVentas = ventas.replace(/<section id="precio".*?<\/section>/s, boticaPrecio);
